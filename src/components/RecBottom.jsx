...
//     const serverIP = 'http://127.0.0.1:5000'; // Pastikan server IP sudah benar
...
//                     console.log('User Data fetched:', data); // Log data user yang diterima
//                     setUserData(data);
//                 } catch (error) {
...
//     return (
//         <div>
//             <p>Recommended Products for Product ID: {product_id}</p>
//             <p>Based on User ID: {userId}</p>

//             {/* Tampilkan data user jika ada */}
//             {userData ? (
//                 <div>
//                     <p>Skin Type: {userData.skintype}</p>
//                     <p>Skin Tone: {userData.skintone}</p>
//                     <p>Under Tone: {userData.undertone}</p>
//                 </div>
//             ) : (
//                 <p>Loading user data...</p> // Tampilkan loading jika data belum ada
//             )}
